...
import { scrapeEbayDirect, formatPrice, formatDate } from './services/ebayDirectScraper';
import './App.css';
...
function App() {
  ...
  const fetchEbaySales = async (cardName, cardNumber) => {
    ...
    try {
      console.log('🛒 Recherche ventes eBay terminées...');
      const sales = await scrapeEbayDirect(cardName, cardNumber);
        ...
        {card && (
          <div className="card-result">
            ...
            <div className="ebay-sales" style={{ marginTop: '30px' }}>
              <h3>💰 Ventes eBay terminées (90 jours)</h3>

              {loadingEbay && (
                <div style={{ textAlign: 'center', padding: '20px' }}>
                  <div className="spinner"></div>
                  <p>Recherche des ventes terminées...</p>
                </div>
              )}
                        ...
                        <div style={{ display: 'flex', gap: '12px' }}>
                          ...
                          <div style={{ flex: 1 }}>
                            ...
                            <p style={{ fontSize: '0.75em', color: '#999' }}>
                              {item.condition} • Vendu {formatDate(item.soldDate)}
                            </p>
                            <a
                              href={item.url}
                              target="_blank"
